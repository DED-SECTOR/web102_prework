...
const unfundedGamesText = `We currently have ${unfundedGamesCount} ${unfundedGamesCount === 1 ? 'game' : 'games'} that still need funding.`;

// create a new DOM element containing the template string and append it to the description container
const descriptionText = document.createElement("p");
descriptionText.textContent = `The purpose of our company is to fund independent games. We've been in operation for 12 years. ${unfundedGamesText}`;
